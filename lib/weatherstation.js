...
function weatherstation() {
    ...
    var appid = '&appid=f3dd8641cab01686e23898c59dff936b';

    var city = '2654675';

    var latlong = 'lat=51.509517&lon=-2.642328';

    var forcast3hrUrl = "http://api.openweathermap.org/data/2.5/forecast?id="+city+"&units=metric"+appid;

    var forcastUrl = "http://api.openweathermap.org/data/2.5/forecast/daily?id="+city+"&mode=json&units=metric&cnt=3"+appid;
    var weatherUrl = "http://api.openweathermap.org/data/2.5/weather?"+latlong+"&mode=json&units=metric"+appid;
    ...
    loopWeather();
    setInterval(loopWeather, (60000*15));
