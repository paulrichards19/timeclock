...
function scheduler(datastore, eventEmitter, weatherstation, temp) {
    ...
    function heatOn(type){
        ...
        heating_status = 1;
        eventEmitter.emit('change:heat', 1, type);
        ...
        var data = {
            ...
            heat: 0,
            date: new Date,
            inside: temp.getData().today.heat.temperature,
            outside: currentOutSideTemp
        };
    ...
    function heatOff(type){
        ...
        heating_status = 0;
        eventEmitter.emit('change:heat', 0, type);
